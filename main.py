...
pygame.display.set_caption("Simulacion Sistema Solar")
...
class Planet:
    ...
    def draw(self, win):
        ...
        if not self.sun:
            distance_text = FONT.render(f"{round(self.distace_to_sun/1000, 1)}km", 1, WHITE)
...
def main():
    ...
    venus = Planet(0.723 * Planet.AU, 0, 10, RED_V, 4.8685 * 10**24)
